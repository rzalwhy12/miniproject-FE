              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
                ...
                <div className="space-y-2">
                  ...
                  <input
                    type="date"
                    value={
                      voucher.startDate ? voucher.startDate.slice(0, 10) : ''
                    }
                    onChange={(e) =>
                      handleVoucherChange(idx, 'startDate', e.target.value)
                    }
                ...
                <div className="space-y-2">
                  ...
                  <input
                    type="date"
                    value={voucher.endDate ? voucher.endDate.slice(0, 10) : ''}
                    onChange={(e) =>
                      handleVoucherChange(idx, 'endDate', e.target.value)
                    }
                    className="bg-white/90 border-gray-300 text-gray-800 focus:border-pink-500 focus:ring-pink-500/20 w-full rounded px-2 py-1"
                  />
                </div>
